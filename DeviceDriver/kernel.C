...
void fun2()
{
    ...
    for (int j = 0;; j++)
    {
        ...
        Console::puts("Reading done for 2 ...\n");
...
//             Console::puti(buf[i]);
//         }
//         Console::puts("Reading done fun3 ...\n");
//         Console::puts("Writing a block to disk...\n");
//         SYSTEM_DISK->write(write_block, buf);
//         Console::puts("Writing is OVER!!!!\n");
//         /* -- Move to next block */
...
int main()
{
    ...
    SYSTEM_SCHEDULER->initilase_disk(SYSTEM_DISK);
#else
    SYSTEM_DISK = new DiskMirror(DISK_ID::MASTER, SYSTEM_DISK_SIZE);
    SYSTEM_SCHEDULER->initilase_disk(SYSTEM_DISK);
#endif
#ifdef _ENABLE_INTERRUPT
